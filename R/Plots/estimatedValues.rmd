...
# estimated Ts
Ts_min = min(predictionsEnsemble_brooder_matrix[,1] - quantile*predictionsEnsemble_brooder_matrix[,11])
Ts_max = max(predictionsEnsemble_brooder_matrix[,1] + quantile*predictionsEnsemble_brooder_matrix[,11])
...
# estimated qs
qs_min = min(predictionsEnsemble_brooder_matrix[,2] - quantile*predictionsEnsemble_brooder_matrix[,12])
qs_max = max(predictionsEnsemble_brooder_matrix[,2] + quantile*predictionsEnsemble_brooder_matrix[,12])
...
# estimated Th
Th_min = min(predictionsEnsemble_brooder_matrix[,3] - quantile*predictionsEnsemble_brooder_matrix[,13])
Th_max = max(predictionsEnsemble_brooder_matrix[,3] + quantile*predictionsEnsemble_brooder_matrix[,13])
...
# estimated Ts
Ts_min = min(predictionsEnsemble_brooderAddedInc_matrix[,1] - quantile*predictionsEnsemble_brooderAddedInc_matrix[,11])
Ts_max = max(predictionsEnsemble_brooderAddedInc_matrix[,1] + quantile*predictionsEnsemble_brooderAddedInc_matrix[,11])
...
# estimated qs
qs_min = min(predictionsEnsemble_brooderAddedInc_matrix[,2] - quantile*predictionsEnsemble_brooderAddedInc_matrix[,12])
qs_max = max(predictionsEnsemble_brooderAddedInc_matrix[,2] + quantile*predictionsEnsemble_brooderAddedInc_matrix[,12])
...
# estimated Th
Th_min = min(predictionsEnsemble_brooderAddedInc_matrix[,3] - quantile*predictionsEnsemble_brooderAddedInc_matrix[,13])
Th_max = max(predictionsEnsemble_brooderAddedInc_matrix[,3] + quantile*predictionsEnsemble_brooderAddedInc_matrix[,13])
...
# lower CI
Hopt_min = min(supplemental_heat_Ta_brooderAddedInc$min_power_lower_real)
Hopt_max = max(supplemental_heat_Ta_brooderAddedInc$min_power_upper_real)
image2D(supplemental_heat_Ta_brooderAddedInc$min_power_lower_real, contour = list( labcex = 1.6, lwd = 4, vfont = c("sans serif", "bold italic")), 
        ...
        xlab = "Weight (kg)", 
        ylab = expression(paste("Air temperature ("^{o},"C)", sep = "")),
        zlim = c(Hopt_min, Hopt_max),
        mgp=c(2.3,0.7,0), cex.axis = 1.4, cex.lab = 1.6, xaxt = "n")
axis(1, c(1, 5, 10, 15, 20), cex.axis = 1.4, mgp=c(2.3,0.7,0))
rect(weight_min, Ta_brooder_min, weight_max, Ta_brooder_max, lty = 2, lwd = 3)

# lower CI
Eimb_min = min(supplemental_heat_Ta_brooderAddedInc$min_val_lower_neg_abs_filt)
Eimb_max = max(supplemental_heat_Ta_brooderAddedInc$min_val_upper_neg_abs_filt)
...
legend(6.2, 42.5, c("This paper", "Mount (1960)", "Harmon and Xin (1995)", "Brown-Brandl et al. (2004)"), lwd = 4, lty = c(lty.mine, lty.Mount, lty.Xin, lty.BB), col = c(color.mine, color.Mount, color.Xin, color.BB), cex = 1.4, xpd = NA)
```
...
plot(supplemental_heat_Ta_brooderAddedInc$weights, Ta_neutral_Ta_brooderAddedInc_mean, type = 'l', ylim = c(14, 36), col = color.mine, lty = lty.mine, xaxs = "i", xaxt = "n",
     ylab = expression(paste("Temperature ("^{o},"C)", sep = "")), mgp=c(2.3,0.7,0), xlab = "Weight (kg)", cex.axis = 1.4, cex.lab = 1.6, lwd = lwd.mine)
axis(1, c(1, 5, 10, 15, 20), cex.axis = 1.4, mgp=c(2.3,0.7,0))
grid()
lines(supplemental_heat_Ta_brooderAddedInc$weights, Ta_neutral_Ta_brooderAddedInc_lower, col = color.mine, lty = lty.mine, lwd = lwd.mine.CI)
lines(supplemental_heat_Ta_brooderAddedInc$weights, Ta_neutral_Ta_brooderAddedInc_mean, col = color.mine, lty = lty.mine, lwd = lwd.mine)
...
legend(4, 42.5, c("This paper", "Harmon and Xin (1995)", "Brown-Brandl et al. (2004)"), lwd = 4, lty = c(lty.mine, lty.Xin, lty.BB), col = c(color.mine, color.Xin, color.BB), cex = 1.4, xpd = NA)
```
