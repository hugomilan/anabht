function grad = gradientObjectiveFunctionKM(T, A, E, b)
%
...
%
% 
% File:   gradientObjectiveFunctionKM.m
...
%
% Usage:
% grad = gradientObjectiveFunctionKM(T, A, E, b)
%
% Input:
% T: Temperatures (oC)
...
%
% Output:
% grad: Gradient for temperature T_i
% 

grad = (2*(A*T + E*T.^4 + b)'*(A + 4*E*T.^3))';